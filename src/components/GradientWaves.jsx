 ...
 * etc.
 *
 * Para classes Tailwind/shadcn, o navegador resolve
 * a cor final através do CSS.
 */
...
const GradientWaves = ({
  ...
  useEffect(() => {
    ...
    const h = resolveColor(horizonColor);

    const w = resolveColor(waveColor);

    const cr = resolveColor(crestColor);
